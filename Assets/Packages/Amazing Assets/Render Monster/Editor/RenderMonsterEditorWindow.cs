...
namespace AmazingAssets.RenderMonster
{
    ...
    public class RenderMonsterEditorWindow : Editor
    {
        ...
        {
            GUILayout.Space(5);
            RenderMonsterEditorGUIHelper.Header("Image Sequence");
            ...
            EditorGUI.indentLevel += 1;
            {
                ...
                GUI.enabled = Application.isPlaying ? true : false;
                {
                    GUI.backgroundColor = _target.IsRecording() ? Color.red : Color.white;
                    {
        ...
        {
            GUILayout.Space(5);
            RenderMonsterEditorGUIHelper.Header("Screenshot");
            ...
            EditorGUI.indentLevel += 1;
            {
                ...
                GUI.enabled = IsOutputFolderValid(outputPath.stringValue);
                {
        ...
        {
            GUILayout.Space(5);
            RenderMonsterEditorGUIHelper.Header("Output");

            EditorGUI.indentLevel += 1;
            {
                EditorGUILayout.BeginHorizontal();
                {
                    GUI.backgroundColor = IsOutputFolderValid(outputPath.stringValue) ? Color.white : Color.red;
                    {
